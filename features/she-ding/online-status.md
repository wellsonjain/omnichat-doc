...
### 設定為已離線狀態時，將會影響對話自動指派行為

若於 Omnichat 系統後台有使用對話自動指派功能，**於團隊成員狀態設定為已離線時，則對話自動指派功能將會**<mark style="color:red;">**暫停觸發**</mark>，直到該名團隊成員狀態恢復為上線中，才會恢復自動指派運作機制。而在每次手動調整上線狀態，系統也會同步彈出相關顯示提示訊息，團隊可依照成員上、下班時間來做自由運用
