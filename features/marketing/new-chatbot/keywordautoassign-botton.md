---
description: 關鍵字自動指派適用平台：僅 WhatsApp 適用，未來將開放其他社群平台
---
...
2. 目前關鍵字自動指派卡片<mark style="color:red;">**無法與排程回覆卡片、條件分流卡片同時並行**</mark>，在設計時請特別留意
3. 若需要使用此張卡片，請先至關鍵字自動指派頁面設定好您的分組條件
{% endhint %}
