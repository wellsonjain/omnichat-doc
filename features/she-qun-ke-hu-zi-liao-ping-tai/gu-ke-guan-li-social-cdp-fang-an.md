...
<figure><img src="../../.gitbook/assets/截圖 2025-09-26 下午2.40.52拷貝 (1).png" alt=""><figcaption></figcaption></figure>

1. **名單配額使用量：**&#x5DF2;使用的名單配額量、佔比及剩餘配額數。
2. **整合渠道：**&#x6574;合單一顧客（Omni-customer）的不同渠道，如 Facebook 粉專、LINE 官方帳號、 WhatsApp 號碼、Instagram 帳號、網站。
3. **標籤：**&#x6574;合單一顧客（Omni-customer）於不同渠道被貼上的標籤。
4. **自訂屬性：**&#x6574;合單一顧客（Omni-customer）於不同渠道蒐集到的自訂屬性。

{% hint style="info" %}
自訂屬性（Custom Attribute）：為品牌端自定義欄位，可存入資料。
{% endhint %}

5. **搜尋：**&#x53EF;依照特定條件搜尋出特定顧客（Omni-customer）
6. **更多功能：**
   1. **匯出：**&#x65B0;增不同條件（例如標籤），點選 「 套用 」 篩選特定聯絡人，可將 LINE - UID 、 Facebook - PSID、Instagram - IGSID、WhatsApp - 電話號碼匯出為 CSV 檔案。
   2. **匯入：**&#x95DC;於匯入聯絡人，請參閱 [匯入顧客資料](https://docs.omnichat.ai/features/she-qun-ke-hu-zi-liao-ping-tai/hui-ru-gu-ke-zi-liao) 。
7. **動作按鈕－查看詳情：**&#x55AE;一顧客（Omni-customer）的360°輪廓。

### 顧客檔案－查看詳情(1\~4)

<figure><img src="../../.gitbook/assets/截圖 2025-09-26 下午2.59.46.png" alt=""><figcaption></figcaption></figure>
...
#### （4）跨渠道聯絡人狀態：**介面依篩選渠道呈現**

*   **篩選介面（ LINE ）**

    <div align="center"><figure><img src="../../.gitbook/assets/6.jpg" alt="" width="408"><figcaption></figcaption></figure></div>
...
*   **介面右下方 (取消訂閱／前往對話)**
    ...
    <div align="left"><figure><img src="../../.gitbook/assets/15.jpg" alt="" width="293"><figcaption></figcaption></figure></div>
