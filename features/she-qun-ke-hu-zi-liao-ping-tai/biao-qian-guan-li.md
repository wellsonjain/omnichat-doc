...
<figure><img src="../../.gitbook/assets/截圖 2025-10-03 下午4.11.39 (1).png" alt=""><figcaption></figcaption></figure>
...
4. **建立新標籤：**&#x65B0;增標籤。
5. **☐：**&#x53EF;勾選特定標籤。
6. **有效時間：**&#x5206;為 「 永久 」 與ㄈ 「 限期 」 兩種，詳細設定請見[下方說明](biao-qian-guan-li.md#biao-qian-de-you-xiao-shi-jian-she-ding)。
7. **最後貼標時間：**&#x6700;後一次貼上標籤的時間。
8. **貼標人數：**&#x88AB;貼上標籤的所有人數（不重複計算）。
9. **動作：**&#x53EF;編輯標籤類別、有效時間。
...
1. 建立新標籤時，可同時設定標籤的有效時間。
2. 現有標籤可以點擊 「動作」 來編輯有效時間。
3. 有效時間可設定以下兩種形式：
