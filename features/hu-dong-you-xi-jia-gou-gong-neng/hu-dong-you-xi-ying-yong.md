---
description: 當互動遊戲建置好，Omnichat 教你簡單五招能更快地讓客人進入到設計好的遊戲遊玩唷！
---

# 互動遊戲應用

1. 透過 QR Code 在你的宣傳文案中放入互動遊戲 URL，直接分享給你的粉絲們
2. 透過 LINE 圖文選單引導客人開始玩遊戲
3. 透過機器人設定引導客人玩遊戲
4. 讓門市消費者簡單一掃加入LINE 好友，立即玩遊戲
5. 讓 Instagram 好友跟您的官方帳號透過遊戲來互動

## 秘笈一：在宣傳文案中放入互動遊戲 URL，直接分享給你的粉絲們
...
## 秘笈三：透過聊天機器人設定引導客人玩遊戲

聊天機器人可以應用在 Omnichat 後台系統的各個功能上。關於機器人設定請參考[這裡](../marketing/chatbot-builder/)

首先，請先設定一個機器人模組，將**遊戲連結 URL** 放進已設計過機器人模組中的卡片按鈕內，按下『儲存』

![聊天機器人 1.0 截圖畫面](<../../.gitbook/assets/截圖 2021-12-27 下午4.13.48.png>)

<figure><img src="../../.gitbook/assets/截圖 2025-11-20 下午2.24.17.png" alt=""><figcaption><p>聊天機器人 2.0 截圖畫面</p></figcaption></figure>

接著，這裡將舉例介紹三種機器人模組在 Omnichat 功能的應用，分別是透過『綁定』、『訊息自動回覆』跟『推播訊息』來依序說明。

### 1. 將互動遊戲變成 『綁定』 誘因，當客人透過點擊社群身份綁定按鈕完成綁定後，即提供遊戲進行遊玩

#### 步驟ㄧ：『官網綁定』 頁面，將訂閱成功訊息選用 『機器人模組』&#x20;

<figure><img src="../../.gitbook/assets/截圖 2025-11-20 下午2.26.59.png" alt=""><figcaption></figcaption></figure>



#### 步驟二： 讓完成 『官網綁定』 的客人可以被訂閱成功訊息引導去玩遊戲。

![](../../.gitbook/assets/社群身份綁定完成玩遊戲.gif)

### 2. 訊息自動回覆設定，引導客人輸入關鍵字後觸發機器人模組直接玩遊戲

透過客人輸入關鍵字，進而觸發機器人模組來玩遊戲。

#### 步驟一：先到 『[訊息自動回覆](../marketing/keyword-autoreply.md)』 中設定關鍵字
