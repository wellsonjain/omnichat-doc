...
3. 設定發送的訊息內容是要使用哪一個機器人模組。\
   按下 「 編輯模組 」 ，會另開一個分頁進到 「 自助設計機器人 」 中的 「 Abandoned Cart Messages 購物車再行銷機器人 」 的編輯頁面去設定詳細發送訊息的內容

<figure><img src="../../.gitbook/assets/截圖 2025-10-29 下午1.52.59.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/截圖 2025-10-29 下午1.53.42.png" alt=""><figcaption></figcaption></figure>
