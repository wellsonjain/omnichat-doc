...
<figure><img src="../../.gitbook/assets/機器人2.0 (3).png" alt=""><figcaption></figcaption></figure>
...
7. **綁定設定 - 綁定成功訊息：**&#x7D81;定成功後在 LINE 渠道上會發送的成功訊息，支援以下三種樣式
   1. **不發送：**&#x9810;設選項
   2. **文字：**&#x5FC5;填、無字數上限
   3. **機器人模組：**&#x4F9D;照設定的平台顯示不同可選的機器人模組
8. **綁定設定 - 綁定成功後貼標：**&#x8A2A;客透過彈出式綁定訊息綁定成功後，為他貼上特定標籤。
