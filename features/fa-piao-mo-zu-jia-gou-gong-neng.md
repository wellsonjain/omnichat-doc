...
🙌🏻  適用對象為加購開通發票活動的顧客，並且目前僅支援 LINE 渠道，若有興趣，歡迎洽詢業務或服務窗口開通此功能！
...
<figure><img src="../.gitbook/assets/截圖 2025-12-09 下午3.43.50.png" alt=""><figcaption></figcaption></figure>

從側欄選單 「 發票活動 」 進入此功能，你會看到發票活動列表。此頁包含以下功能：

1. 活動名稱
2. 活動日期
3. 渠道
4. 上傳發票數
5. 活動狀態：分為「草稿」、「進行中」、「排程中」、「暫停中」與「已結束」。
6. 動作按鈕:可編輯、複製發票活動，以及查看發票活動資訊。
7. 可搜尋特定活動或渠道名稱
8. 新增發票活動
...
<figure><img src="../.gitbook/assets/截圖 2025-12-09 下午3.48.01.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/截圖 2025-12-09 下午3.50.18.png" alt=""><figcaption></figcaption></figure>
...
{% hint style="info" %}
**系統預設：同一張發票可參加團隊內多個發票活動（系統以「活動」為重複上傳的驗證範圍）。**

**若希望改為 「一張發票僅能參加一個活動」，請聯繫您的專屬顧問、或於後台插件詢問客服團隊，另外調整。**
{% endhint %}
...
再次提醒，若顧客於觸發發票活動後超過 30 分鐘才拍照上傳發票，則不會進行任何驗證、處理。
...
| 活動不存在  | <p>➊ 該 LINE Channel 未設定 Liff ID<br>➋ 解除串接該渠道<br>➌ 發票活動暫停<br>➍ 發票活動卡片傳送至不同渠道</p> | 很抱歉，此活動已不存在                                                                                        | -                                 | 否                                                    |
| 未預期錯誤  | <p>前述任何情形外之狀況發生時<br>，由商家端發出。</p>                                                | 發票登錄失敗，請稍後再試                                                                                       | <p>- 拍照上傳<br>- 手動上傳<br>- 電子載具</p> | 否                                                    |

#### **驗證訊息（可自行編輯內容）**

<figure><img src="../.gitbook/assets/截圖 2025-12-09 下午3.52.50.png" alt=""><figcaption></figcaption></figure>
