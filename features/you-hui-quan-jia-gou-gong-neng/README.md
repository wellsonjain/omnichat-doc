...
<div align="left"><figure><img src="../../.gitbook/assets/截圖 2024-11-04 下午4.47.53.png" alt=""><figcaption></figcaption></figure></div>
...
<div><figure><img src="../../.gitbook/assets/IMG_9918.jpg" alt="" width="375"><figcaption><p>使用期限倒數中優惠券</p></figcaption></figure> <figure><img src="../../.gitbook/assets/IMG_9919.jpg" alt="" width="375"><figcaption><p>已過期優惠券</p></figcaption></figure></div>
...
{% hint style="danger" %}
請留意：目前當優惠券類型設定為「序號包」時，系統**尚不支援與推播功能同時使用**。
{% endhint %}
...
一開始先設定每位顧客最多領取1次並發布，顧客A成功領到優惠券。

此時重新調整成可領取5次並發布，顧客A符合再次領取優惠券資格。

接著又再次調整回領取1次為限並發布，顧客A此時如再觸發領券流程，會跳出已達領取上限之資訊（系統會回溯先前已發券的紀錄）。
{% endhint %}
...
<div align="left"><figure><img src="../../.gitbook/assets/未命名簡報.png" alt=""><figcaption></figcaption></figure></div>
