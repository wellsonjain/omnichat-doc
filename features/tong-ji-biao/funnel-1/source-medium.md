...
* 預設表格排序是由最多到最少的轉換率％
* 數據的日期區間，如果沒有做調整的話，它是從今天開始算到過去 14 天（二週）

### 表格說明

<figure><img src="../../../.gitbook/assets/截圖 2025-07-09 上午11.25.45.png" alt=""><figcaption></figcaption></figure>

1. 工作階段（All Sessions）：所有 來源 / 媒介 的**工作階段總和**
2. 交易（Transaction / Purchase）：所有 來源 / 媒介 的 **交易總和**
3. 轉換率（Conversion) = ( 交易／工作階段 ) \* 100：所有 來源 / 媒介 的 **平均轉換率％**
4. 收益（Revenue）：所有 來源 / 媒介 的 **收益總和**
5.  佔總數 =`（本項 來源/媒介的數據 ／ 所有來源 來源/媒介的數據）* 100`

    `95,546 / 445,266 = 21.46%`
...
可使用**搜尋列**篩選出帶有 omnichat 的來源/媒介

<figure><img src="../../../.gitbook/assets/截圖 2025-07-09 上午11.29.52.png" alt=""><figcaption></figcaption></figure>
