---
description: 訊息報表此功能限有購買 WhatsApp Business API 方案用戶使用
---

# WhatsApp 訊息報表

WhatsApp 的訊息報表頁面會顯示免費與付費的對話數量，並以圖表呈現付費對話總數費用。而在此統計表當中的數值為<mark style="color:red;">**近似值**</mark>，實際收費請以每月所收到的 WhatsApp 對話費用明細為準。
...
* 當日數據更新頻率為：每小時/次
* 「所有地區」可篩選特定地區的聊天對話量，分為：全部地區、亞洲地區、非亞洲地區
...
2023/06/01起，WhatsApp Business API的對話收費方式中&#x7684;**「商家發起」**，將細分&#x70BA;**「公用對話」**、**「驗證對話」**、**「行銷對話」等3種對話，「用戶發起」**&#x5C07;會屬&#x65BC;**「服務對話」**&#x4E0D;同類別的對話會有不同對話費率，因此在訊息報表當中將會呈現是由哪一種對話的相關資料
